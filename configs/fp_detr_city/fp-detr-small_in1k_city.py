                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            num_heads=8,
                            dropout=0.1,
                            shared=True),  # the norms are not shared
                        dict(
...
load_from = "pretrained_weights/fp-detr-small/pretrained_epoch_299.pth"
